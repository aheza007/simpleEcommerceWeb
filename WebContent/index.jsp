...
<link
	...
	rel='stylesheet' type='text/css'>
<link href="./assets/template1/assets/css/bootstrap.css"
	rel="stylesheet">
<link href="./assets/template1/assets/css/bootstrap-responsive.css"
	rel="stylesheet">
<link href="./assets/template1/assets/css/docs.css" rel="stylesheet">
<link
	href="./assets/template1/assets/js/google-code-prettify/prettify.css"
	rel="stylesheet">
<link href="./assets/template1/assets/css/style.css" rel="stylesheet">
<link rel="stylesheet"
	href="./assets/template1/assets/css/flexslider.css" type="text/css"
	media="screen" />
<link rel="stylesheet" type="text/css"
	href="./assets/template1/fancybox/jquery.fancybox-1.3.4.css"
	media="screen" />
...
<body>
	...
	<header>
			...
			<div class="container">
				...
				<ul class="nav pull-right left-tablet">
					<li class="dropdown hover"><a data-toggle=""
						class="dropdown-toggle" href="#">US Dollar <b class="caret"></b></a>
									...
									<tbody>
										...
										<tr>
											<td class="image"><a href="<%=p.getImage()%>"><img
													title="product" alt="product" src="<%=p.getImage()%>"
		...
		<div class="header-white">
			<div class="container">
				<div class="row">
					<div class="span4">
						<a class="logo" href="Home"><img src="./images/logo.png"
							alt="ShopSimple" title="ShopSimple"></a>
					</div>
					<div class="span8">
						<div class="row">
							<div class="pull-right logintext">
								...
								<table>
									<tr>
										<td><span class="frame"> <img width="50"
												height="50" alt="" src="<%=utilisateur.getPhoto()%>">
										</span></td>

										<td>Welcome, <%=utilisateur.getUsername()%> <br> <a
						...
						<li><img src="./images/slider1.jpg" alt="" />
							...
							<div class="bannerpriceround">
								<div class="bannerpriceroundinner">
									<span class="oldprice">$260</span><span class="newprice">$199</span><span
										class="bestdeal">Best Deal</span>
								</div>
							</div></li>
		...
		<section id="featured">
			<div class="container">
				...
				<ul class="thumbnails">
					...
					<li class="span3"><a class="prdocutname" href="#"><%=u.getNom()%></a>
						<div class="thumbnail">
							<a href="product.html"> <img alt="" src="<%=u.getImage()%>"></a>
							<div class="caption">
								<div class="price pull-left">
									<span class="oldprice"><%=u.getPrix()%></span> <span
										class="newprice"><%=u.getPrix()%></span>
								</div>
								<a class="cartadd pull-right tooltip-test"
									href="Product?id=<%=u.getId()%>&action=show"
									title="Add to Cart"> Add to Cart </a> <span
									class="links pull-left"><a class="info"
									href="product.html">info</a> <a class="wishlist"
									href="wishlist.html">wishlist</a> <a class="compare"
									href="compare.html">compare</a> </span>
							</div>
						</div></li>
					...
					<div class="row">
						<div class="span3 aboutus">
							...
							<p>
								...
								<br> t has survived not only five centuries, but also the
    ...
    ================================================== -->
		...
		<script
			src="./assets/template1/assets/js/google-code-prettify/prettify.js"></script>
		...
		<script type="./assets/template1/text/javascript"
			src="assets/js/jquery.tweet.js"></script>
